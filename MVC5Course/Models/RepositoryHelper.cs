namespace MVC5Course.Models
{
	public static class RepositoryHelper
	{
		...
		public static View_testRepository GetView_testRepository()
		{
			var repository = new View_testRepository();
			repository.UnitOfWork = GetUnitOfWork();
			return repository;
		}

		public static View_testRepository GetView_testRepository(IUnitOfWork unitOfWork)
		{
			var repository = new View_testRepository();
			repository.UnitOfWork = unitOfWork;
			return repository;
